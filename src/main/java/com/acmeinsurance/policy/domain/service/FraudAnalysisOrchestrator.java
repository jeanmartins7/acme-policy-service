package com.acmeinsurance.policy.domain.service;
...
import com.acmeinsurance.policy.domain.strategy.FraudRiskStrategyContext;
import com.acmeinsurance.policy.enums.PolicyStatusEnum;
import com.acmeinsurance.policy.infrastructure.integration.fraud.service.FraudApiService;
                ...
                .flatMap(policyRequest -> {
                    return fraudApiService.analyzePolicyRequest(policyRequest.getId(), policyRequest.getCustomerId())
                            .flatMap(fraudResult -> {
                                ...
                                final PolicyStatusEnum newStatus = fraudRiskStrategyContext.evaluate(fraudResult);
